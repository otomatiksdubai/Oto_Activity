...
export default function Landing() {
  ...
  const testimonials = [
    ...
    { name: 'Anil Nairs', role: 'Local Guide', text: 'Impressed with what Otomatiks have achieved so far in its short tenure. Iam sure the kids are much enriched in their pursuit of Robotics and STEM knowledge. Dubai is truly blessed to have you.' },
  ...
  <>
    ...
    <div className="landing-wrapper">
      <nav className={`landing-nav ${menuOpen ? 'menu-is-open' : ''} ${isScrolled ? 'scrolled' : ''}`}>
        <div className="landing-container">
          <div className="landing-logo-text">
            <img src={logo} alt="Otomatiks Robotics Training Centre Dubai" style={{ height: '40px', verticalAlign: 'middle', marginRight: '10px' }} />
          </div>
        ...
        <div className="landing-container">
          <div className="hero-grid">
            ...
            <div className="hero-image-wrapper">
              <img src={heroKids} alt="Kids learning robotics with sensors and LEGO kits at Otomatiks training centre Dubai" />
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="program-grid">
            {[
              ...
              <div className="program-card" key={i}>
                ...
                <img src={p.img} className="program-img" alt={`${p.name} robotics program for kids ${p.tag}`} loading="lazy" />
      ...
      <footer className="landing-footer">
        <div className="landing-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', textAlign: 'center' }}>
          <div style={{ display: 'flex', gap: '24px', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '4px' }}>
            <a
              href="https://www.instagram.com/otomatiks_uae/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Otomatiks on Instagram"
              style={{ color: 'var(--muted)', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '6px' }}
            >
              Instagram
            </a>
            <a
              href="https://www.facebook.com/OtomatiksUAE"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Otomatiks on Facebook"
              style={{ color: 'var(--muted)', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '6px' }}
            >
              Facebook
            </a>
            <a
              href="https://ae.linkedin.com/company/otomatiks-dubai"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Otomatiks on LinkedIn"
              style={{ color: 'var(--muted)', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '6px' }}
            >
              LinkedIn
            </a>
          </div>
          <p className="small muted" style={{ fontSize: '0.8rem' }}>
            No.608, Fortune Executive Tower, Cluster T, Jumeirah Lakes Towers, Dubai, UAE
          </p>
      ...
      <div className="floating-socials">
        ...
        >
          <svg className="whatsapp-icon" viewBox="0 0 448 512" style={{ width: '28px', height: '28px', fill: 'currentColor' }}>
