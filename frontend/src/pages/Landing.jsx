...
// ─── Dirham SVG Component ────────────────────────────────────────────────────
function DirhamIcon({ size = 48, className = '', style = {} }) {
  return (
    <svg className={className} style={{ ...style, flexShrink: 0 }} viewBox="0 0 1000 870" width={size} height={size} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
